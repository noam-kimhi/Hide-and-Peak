    ...
    output_rows.append(
        {
            ...
            "n_contributing_samples": len(
                contributing_sample_indices
            ),
        }
    )
...
def merge_peaks(
    ...
    Merging is transitive. If peak A overlaps peak B and peak B overlaps peak C,
    all three become one consensus interval even when A and C do not directly
    overlap.
