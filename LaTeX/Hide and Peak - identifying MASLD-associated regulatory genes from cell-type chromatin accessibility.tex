...
\begin{document}
  ...
  The sample-level peak sets varied substantially in size and boundary definitions, which motivated the consensus-peak construction described in \cref{sec:methods}.
